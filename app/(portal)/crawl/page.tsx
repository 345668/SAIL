...
export const metadata = { title: "Web crawler — Anker Portal" }
...
export default function Page() {
  ...
  return (
    <PageShell
      eyebrow="Data & growth · crawl"
      title="Web crawler"
      description="Crawl a site into structured pages for enrichment and research. The crawler runs in the tenant app."
    >
      {!configured && (
