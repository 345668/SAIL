...
export const metadata = { title: "AI enrichment — Anker Portal" }
...
export default function Page() {
  ...
  return (
    <PageShell
      eyebrow="Data & growth · enrichment"
      title="AI enrichment"
      description="Fill gaps in investor and firm records from public sources, synthesised by the tenant app's AI router."
    >
      {!configured && (
