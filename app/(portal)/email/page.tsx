...
export const metadata = { title: "Outreach outbox — Anker Portal" }

export default function Page() {
  const configured = !!proxyConfig()
  return (
    <PageShell
      eyebrow="Data & growth · email"
      title="Outreach outbox"
      description="Queued, sent and failed outreach email, with delivery-event sync. Sending runs as the selected tenant user in the tenant app."
    >
      {!configured && (
