...
import { UrlCheckClient } from "./url-check-client"

export const dynamic = "force-dynamic"
export const metadata = { title: "URL health — Anker Portal" }
...
export default function Page() {
  ...
  return (
    <PageShell
      ...
      title="URL health"
      description="Find dead, redirected and mismatched links across the investor and firm records, and repair them in place."
    >
      {!configured && (
