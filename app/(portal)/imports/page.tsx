...
export const metadata = { title: "CSV imports — Anker Portal" }
...
export default function Page() {
  ...
  return (
    <PageShell
      eyebrow="Data & growth · imports"
      title="CSV imports"
      description="Bulk-import investors, firms and contacts from CSV or XLSX, with column mapping and a dry run before anything is written."
    >
      {!configured && (
